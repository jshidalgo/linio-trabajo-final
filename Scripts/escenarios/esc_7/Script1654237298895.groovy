...
String folder = CustomKeywords.'scripts.Utils.getFolderName'('escenario-7')
...
CustomKeywords.'scripts.Search.searchByCategory'('Celulares y Accesorios', 'CELULARES Y TABLETS')
...
tObj.addProperty("xpath", ConditionType.EQUALS, "(//div[@id='catalogue-product-container']/div/a/div[2]/p/span)[1]")
